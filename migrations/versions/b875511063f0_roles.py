...
def upgrade() -> None:
    ...
    participantrole_enum = postgresql.ENUM('owner', 'admin', 'member', name='participantrole')
    ...
    op.add_column('chats', sa.Column('created_at', sa.DateTime(timezone=True), nullable=True))
    op.alter_column(
        'messages',
        'timestamp',
